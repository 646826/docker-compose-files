...
- Optional Authelia authentication with file-backed secrets, local users, SQLite storage, configuration validation, and a Basic Auth rollback path.
...
- Community-service, remote-backup, image-platform, security, and existing stack runtime workflows.
